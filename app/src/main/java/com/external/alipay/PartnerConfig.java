...
//    public static final String ALIPAY_CALLBACK = "http://shop.ecmobile.me/ecmobile/respond.php";
    ...
    public PartnerConfig(Context context) {
    	PARTNER = FarmingManager.getAlipayParterId(context);
    	SELLER = FarmingManager.getAlipaySellerId(context);
    	RSA_PRIVATE = FarmingManager.getRsaPrivate(context);
    	RSA_ALIPAY_PUBLIC = FarmingManager.getRsaAlipayPublic(context);
    	ALIPAY_CALLBACK = FarmingManager.getAlipayCallback(context);
    }

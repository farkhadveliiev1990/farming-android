...
import com.dmy.farming.api.model.WarnDetailModel;
...
public class B01_WarnDetailActivity extends BaseActivity implements OnClickListener,XListView.IXListViewListener, BusinessResponse {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        initView();
        noticeModel = new WarnDetailModel(this, id);
    ...
    TextView title, keyword, time, source;
...
//		groupListModel.getGroupList(request, false);
	...
	public void OnMessageResponse(String url, JSONObject jo, AjaxStatus status) throws JSONException {
		if (url.contains(ApiInterface.WARNDETAIL)) {
	...
	void updateData() {
		...
		if (id.equals(noticeModel.id)) {
            ...
            WARNLIST route = noticeModel.data;
          ...
          final  String[] chrstr = route.keyWord.split(",");
            if(chrstr.length>0){
               for(int i = 0;i<chrstr.length;i++){
                   ...
                   textView.setOnClickListener(new OnClickListener() {
                       @Override
                       public void onClick(View v) {
                           Intent intent = new Intent(B01_WarnDetailActivity.this,B01_SearchActivity.class);
            ...
            source.setText("来源："+route.infoFrom);

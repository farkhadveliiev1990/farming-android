...
public class E01PubilcSellActivity extends BaseActivity implements OnClickListener, BusinessResponse, OnAddressSelectedListener
{
	GridView gridView;
		...
		gridView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
				...
				if ("000000".equals(imgs) ){
					PhotoPickerIntent intent = new PhotoPickerIntent(E01PubilcSellActivity.this);
					...
					PhotoPreviewIntent intent = new PhotoPreviewIntent(E01PubilcSellActivity.this);
	...
	public void onClick(View v) {
		...
		switch(v.getId()) {
			...
			case R.id.text_position:
				positionDialog = new BottomDialog(E01PubilcSellActivity.this);
				positionDialog.setOnAddressSelectedListener(E01PubilcSellActivity.this);
				positionDialog.show();
				break;
			case R.id.text_type:
...
//				intent = new Intent(this,ChoosePublishTypeActivity.class);
				...
				startActivityForResult(intent,REQUEST_SALE_TYPE);
				break;
			case R.id.text_unit:
	...
	private void submit() {
		...
		if (TextUtils.isEmpty(subtitle))
			...
			request.price = /*Float.parseFloat(price)*/ Integer.parseInt(price);
			...
			request.source = "1";
			publishModel.publishSale(request);
		}
	}
	...
	private void showDialog(String title, final ArrayList<String> datalist) {
		AlertDialog.Builder builder = new AlertDialog.Builder(E01PubilcSellActivity.this,AlertDialog.THEME_HOLO_LIGHT);
		View view = LayoutInflater.from(E01PubilcSellActivity.this).inflate(R.layout.dialog,null);
		builder.setView(view);
		((TextView)view.findViewById(R.id.text_title)).setText(title);
		ListView listview = (ListView) view.findViewById(R.id.listview);
		DialogAdapter adapter = new DialogAdapter(E01PubilcSellActivity.this,datalist);
	...
	protected void onActivityResult(int requestCode, int resultCode, Intent data) {
		...
		if (data != null) {
			if (requestCode == REQUEST_SALE_TYPE) {
	...
	public void OnMessageResponse(String url, JSONObject jo, AjaxStatus status)
		...
		if (url.contains(ApiInterface.PUBLISHSALE))
		{
	...
	private class GridAdapter extends BaseAdapter {
		...
		public GridAdapter(ArrayList<String> listUrls) {
			...
			inflater = LayoutInflater.from(E01PubilcSellActivity.this);
		}
		...
		public View getView(int position, View convertView, ViewGroup parent) {
			...
			if (path.equals("000000")){
				...
				Glide.with(E01PubilcSellActivity.this)
						.load(path)

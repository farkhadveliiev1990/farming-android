    ...
    public void finish() {
        if (button_send.isEnabled())
        {
            ...
            mDialog.positive.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    mDialog.dismiss();
                    A03_SignupInfoActivity.super.finish();
                }
            });
        }
        else
            ...
            layout_camera.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View arg0) {
                    ...
                    if (Build.VERSION.SDK_INT >= 23) {
                        int checkCallPhonePermission = ContextCompat.checkSelfPermission(A03_SignupInfoActivity.this, Manifest.permission.CAMERA);
                        if(checkCallPhonePermission != PackageManager.PERMISSION_GRANTED){
                            ActivityCompat.requestPermissions(A03_SignupInfoActivity.this,new String[]{Manifest.permission.CAMERA},222);
                            return;
                        }else{
                            openCamera(); //调用具体方法
                        }

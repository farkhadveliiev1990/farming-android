...
public class E01_FindHelpDetail2ListAdapter extends BaseAdapter {
...
//	List<CHATUSER> friends;
	...
	public E01_FindHelpDetail2ListAdapter(Context context) {
...
//	}
	...
	public View getView(final int position, View convertView, ViewGroup parent) {
		...
		convertView = LayoutInflater.from(mContext).inflate(R.layout.e01_find_help_2_detail, null);

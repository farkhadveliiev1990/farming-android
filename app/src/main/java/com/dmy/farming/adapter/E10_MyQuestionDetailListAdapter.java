...
public class E10_MyQuestionDetailListAdapter extends BaseAdapter {
...
//	List<CHATUSER> friends;
	...
	public E10_MyQuestionDetailListAdapter(Context context) {
...
//	}
	...
	public View getView(final int position, View convertView, ViewGroup parent) {
		...
		convertView = LayoutInflater.from(mContext).inflate(R.layout.e01_my_question_item_list, null);

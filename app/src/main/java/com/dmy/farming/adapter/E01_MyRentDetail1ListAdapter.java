...
public class E01_MyRentDetail1ListAdapter extends BaseAdapter {
...
//	List<CHATUSER> friends;
	...
	public E01_MyRentDetail1ListAdapter(Context context) {
...
//	}
	...
	public View getView(final int position, View convertView, ViewGroup parent) {
		...
		convertView = LayoutInflater.from(mContext).inflate(R.layout.e01_my_rent_detail1, null);

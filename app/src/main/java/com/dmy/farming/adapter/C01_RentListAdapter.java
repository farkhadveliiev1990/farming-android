...
public class C01_RentListAdapter extends BaseAdapter {

	Context mContext;
//	List<CHATUSER> friends;
	ArrayList<RENTLIST> dataList;

	public Handler parentHandler;

	public C01_RentListAdapter(Context context, ArrayList<RENTLIST> dataList) {
...
//	}
	...
	private class ViewHolder {
		...
		public TextView title,price,distance,address_detail,farm,time,text_unit;
...
//			params1.height = (int) (params1.width*1.0/720*330);
		...
		final RENTLIST cat = getItem(position);
		if (cat != null)
		{
			...
			viewHolder.farm.setText(cat.rent_type);
			...
			viewHolder.layout_frame.setOnClickListener(new View.OnClickListener()
			{
				@Override
				public void onClick(View v) {
					RENTLIST data = getItem(position);
					if (data != null)
					{

...
public class E01_MyCollectionDiagnosticListAdapter extends BaseAdapter implements View.OnClickListener {

	Context mContext;
    ArrayList<DIAGNOSTIC> datalist;
	public Handler parentHandler;

	public E01_MyCollectionDiagnosticListAdapter(Context context, ArrayList<DIAGNOSTIC> datalist) {
	...
	public View getView(final int position, View convertView, ViewGroup parent) {
		...
		if (cat != null)
		{
			...
			viewHolder.time.setText(cat.create_time);

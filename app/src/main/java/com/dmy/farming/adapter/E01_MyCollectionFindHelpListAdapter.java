...
public class E01_MyCollectionFindHelpListAdapter extends BaseAdapter implements View.OnClickListener {

	Context mContext;
    ArrayList<FINDHELPLIST> datalist;
	public Handler parentHandler;

	public E01_MyCollectionFindHelpListAdapter(Context context, ArrayList<FINDHELPLIST> datalist) {

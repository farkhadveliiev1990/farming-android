...
public class E01_MyCollectionRentListAdapter extends BaseAdapter implements View.OnClickListener {

	Context mContext;
    ArrayList<RENTLIST> datalist;
	public Handler parentHandler;

	public E01_MyCollectionRentListAdapter(Context context, ArrayList<RENTLIST> datalist) {

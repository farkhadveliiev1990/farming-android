...
public class a_BUY_LIST
{
  ...
  //public PAGINATED paginated = new PAGINATED();
    public ArrayList<BUYLIST> routes = new ArrayList<BUYLIST>();
    public ArrayList<BUYLIST> myBuy = new ArrayList<BUYLIST>();

...
public class a_Sale_LIST
{
  ...
  //public PAGINATED paginated = new PAGINATED();
    public ArrayList<SALELIST> routes = new ArrayList<SALELIST>();
    public ArrayList<SALELIST> mySale = new ArrayList<SALELIST>();
    ...
    public JSONObject  toJson() throws JSONException
    {
        ...
        {
            SALELIST itemData = routes.get(i);

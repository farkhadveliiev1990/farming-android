...
public class EaseSmileUtils {
	...
	EmojiconUtil.EaseEmojiconInfoProvider emojiconInfoProvider;
	...
	static {
		...
		EmojiconUtil.EaseEmojiconInfoProvider emojiconInfoProvider = EmojiconUtil.getInstance().getEaseEmojiconInfoProvider();

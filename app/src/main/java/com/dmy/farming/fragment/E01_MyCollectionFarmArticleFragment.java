...
import com.dmy.farming.adapter.E01_MyCollectionBuyListAdapter;
...
public class E01_MyCollectionFarmArticleFragment extends BaseFragment implements OnClickListener, BusinessResponse, XListView.IXListViewListener {
	...
	View null_pager;
	E01_MyCollectionFarmArticleListAdapter farmArticleListAdapter;
	...
	{
		collectionModel.collectionfarmarticlelist(AppConst.info_from,"6");
	}
	...
	private void updateData() {
		...
		if (collectionModel.data.farmarticles.size() > 0)
		{
			null_pager.setVisibility(View.GONE);
			if (farmArticleListAdapter == null) {
				farmArticleListAdapter = new E01_MyCollectionFarmArticleListAdapter(mActivity, collectionModel.data.farmarticles);
				list_black.setAdapter(farmArticleListAdapter);
			} else {
				farmArticleListAdapter.notifyDataSetChanged();
			}

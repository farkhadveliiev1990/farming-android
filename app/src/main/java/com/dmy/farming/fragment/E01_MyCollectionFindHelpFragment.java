...
import com.dmy.farming.adapter.E01_MyCollectionFindHelpListAdapter;
import com.dmy.farming.adapter.E01_MyCollectionRentListAdapter;
...
public class E01_MyCollectionFindHelpFragment extends BaseFragment implements OnClickListener, BusinessResponse, XListView.IXListViewListener {
	...
	View null_pager;
	E01_MyCollectionFindHelpListAdapter findHelpListAdapter;
	...
	{
		collectionModel.collectionFindHelplist(AppConst.info_from,"9");
	}
	...
	private void updateData() {
		...
		if (collectionModel.data.findhelplists.size() > 0)
		{
			null_pager.setVisibility(View.GONE);
			if (findHelpListAdapter == null) {
				findHelpListAdapter = new E01_MyCollectionFindHelpListAdapter(mActivity, collectionModel.data.findhelplists);
				list_black.setAdapter(findHelpListAdapter);

			} else {
				findHelpListAdapter.notifyDataSetChanged();
			}

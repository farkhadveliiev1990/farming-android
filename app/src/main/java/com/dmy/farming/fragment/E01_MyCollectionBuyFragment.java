...
public class E01_MyCollectionBuyFragment extends BaseFragment implements OnClickListener, BusinessResponse, XListView.IXListViewListener {
	...
	View null_pager;
	E01_MyCollectionBuyListAdapter buyListAdapter;
	...
	{
		collectionModel.collectionBuylist(AppConst.info_from,"7");
	}
	...
	private void updateData() {
		...
		if (collectionModel.data.buylists.size() > 0)
		{
			null_pager.setVisibility(View.GONE);
			if (buyListAdapter == null) {
				buyListAdapter = new E01_MyCollectionBuyListAdapter(mActivity, collectionModel.data.buylists);
				list_black.setAdapter(buyListAdapter);

...
public class E01_MyCollectionRentFragment extends BaseFragment implements OnClickListener, BusinessResponse, XListView.IXListViewListener {
	...
	View null_pager;
	E01_MyCollectionRentListAdapter rentListAdapter;
	...
	{
		collectionModel.collectionRentlist(AppConst.info_from,"8");
	}
	...
	private void updateData() {
		...
		if (collectionModel.data.rentlists.size() > 0)
		{
			null_pager.setVisibility(View.GONE);
			if (rentListAdapter == null) {
				rentListAdapter = new E01_MyCollectionRentListAdapter(mActivity, collectionModel.data.rentlists);
				list_black.setAdapter(rentListAdapter);

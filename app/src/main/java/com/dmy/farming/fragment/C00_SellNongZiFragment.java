...
public class C00_SellNongZiFragment extends BaseFragment implements OnClickListener, BusinessResponse, XListView.IXListViewListener {
...
/*	RouteListModel dataModel;
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		View mainView = inflater.inflate(R.layout.e01_my_sell_nongzi_item, null);
	...
	void initView(View mainView)
	{
		...
		footerView = LayoutInflater.from(mActivity).inflate(R.layout.e01_my_sell_item, null);

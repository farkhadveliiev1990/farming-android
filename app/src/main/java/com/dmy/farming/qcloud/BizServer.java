package com.dmy.farming.qcloud;
...
public class BizServer {
    ...
    /** cos的appid */
    protected  String appid = "1253439103";

    /** appid的一个空间名称 */
    protected  String bucket = "bdgl";
    ...
    private BizServer(Context context){
        ...
        cos = new COSClient(context,appid,config,"qcloud_wukong");
    }
    ...
    public void setFileId(String fileId){
        //this.fileId = "/" + this.bucket + fileId;
        this.fileId = fileId;
    }
    ...
    public String getSign(){
        ...
        urlEncoder(fileId);
        String cgi= ApiInterface.QCLOUD_URL + "?bucket=" + bucket + "&cosPath=" + fileId;

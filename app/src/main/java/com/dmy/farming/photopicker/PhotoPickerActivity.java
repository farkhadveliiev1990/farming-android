package com.dmy.farming.photopicker;
                ...
                if (mImageAdapter.isShowCamera()) {
                    ...
                    if (i == 0) {
                        ...
                        if (Build.VERSION.SDK_INT >= 23) {
                            int checkCallPhonePermission = ContextCompat.checkSelfPermission(mCxt, Manifest.permission.CAMERA);
                            if(checkCallPhonePermission != PackageManager.PERMISSION_GRANTED){
                                ActivityCompat.requestPermissions(PhotoPickerActivity.this,new String[]{Manifest.permission.CAMERA},222);
                                return;
                            }else{
                                showCameraAction(); //调用具体方法
                            }
                        } else {
                            showCameraAction(); //调用具体方法
                        }
        ...
        switch (requestCode) {
            ...
            case 222:
                if (grantResults[0] == PackageManager.PERMISSION_GRANTED) {
                    ...
                    // Permission Denied
                    Toast.makeText(mCxt, "请开启相机权限", Toast.LENGTH_SHORT).show();
                }
                break;
            default:

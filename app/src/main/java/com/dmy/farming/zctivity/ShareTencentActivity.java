	...
	protected void onCreate(Bundle savedInstanceState) {		
		...
		share.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {				
		        ...
		        {
		            if(FarmingManager.getTencentKey(ShareTencentActivity.this) != null && FarmingManager.getTencentSecret(ShareTencentActivity.this) != null) {
						long appid = Long.valueOf(FarmingManager.getTencentKey(ShareTencentActivity.this));
			            String app_secket = FarmingManager.getTencentSecret(ShareTencentActivity.this);
    ...
    private void tencentAuth(long appid, String app_secket)
    {
        ...
        AuthHelper.register(this, appid, app_secket, new OnAuthListener() {
            ...
            public void onWeiBoNotInstalled() {
                ...
                i.putExtra("APP_KEY", FarmingManager.getTencentKey(ShareTencentActivity.this));
                i.putExtra("REDIRECT_URI", FarmingManager.getTencentCallback(ShareTencentActivity.this));

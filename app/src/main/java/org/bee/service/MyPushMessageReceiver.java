...
public class MyPushMessageReceiver extends PushMessageReceiver {
    ...
    public void onBind(Context context, int errorCode, String appid,
        ...
        if (errorCode == 0) {
            ...
            editor.commit();
            AppUtils.setChannelId(context, channelId);
            AppUtils.setUploadDev(context, false);
        }
    }
    ...
    public void onNotificationArrived(Context context, String title,
        ...
        String notifyString = "通知到达 onNotificationArrived  title=\"" + title + "\" description=\"" + description + "\" customContent=" + customContentString;
        ...
        if (!TextUtils.isEmpty(customContentString))
        {
            ...
            responseIntent = new Intent(MainActivity.ACTION_SHOW_MESSAGE);
            responseIntent.setClass(context, MainActivity.class);
            responseIntent.addFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
            if(customContentString != null)
            {
                responseIntent.putExtra(MainActivity.CUSTOM_CONTENT, customContentString);
            }
            ...
            String description, String customContentString)
    {
        ...
        {
            Intent responseIntent;
            responseIntent = new Intent(MainActivity.ACTION_PUSHCLICK);
            responseIntent.setClass(context, MainActivity.class);
            responseIntent.addFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
            if(customContentString != null)
            {

...
import org.bee.Utils.JsonFormatTool;
...
public class BeeCallback<T> extends AjaxCallback<T>
{
    ...
    public BeeCallback setParams(String apiPath, Map<String, String> params)
    {
        if (params == null)
        {
        ...
        String kaSign = "";//getMd5Value("oIkBLWG4OUHTgYmN" + params.get("json") + timestamp.toString() + "oIkBLWG4OUHTgYmN");
        header("XXDH-Sign", kaSign)
                .header("XXDH-App-Version", "2.0.0")
                .header("XXDH-Os-Type", "1")
                .url(apiPath)
                .params(params);

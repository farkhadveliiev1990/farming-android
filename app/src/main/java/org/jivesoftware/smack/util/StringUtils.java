...
public class StringUtils {
    ...
    private static final DateFormat dateTimeMicrosFormatter = DateFormatType.XEP_0082_DATETIME_MICROS_PROFILE.createFormatter();
    ...
    static {
        ...
        dateTimeMicrosFormatter.setTimeZone(utc);
        ...
        couplings.add(new PatternCouplings(dateTimePattern, dateTimeMicrosFormatter, true));
    ...
    private static class PatternCouplings {
    	...
    	public String convertTime(String dateString) {
            if (dateString.charAt(dateString.length() - 1) == 'Z') {
                if (dateString.charAt(dateString.length() - 8) == '.')
